...
function validate(isSubmitted = false) {
    ...
    let hobbies2 = document.getElementById('Cricket').checked
    let hobbies3 = document.getElementById('Gyming').checked
    let hobbies4 = document.getElementById('Artical Writing').checked
    let error = false
